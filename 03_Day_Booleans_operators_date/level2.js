...
console.log(
  "Ther perimeter of the triangle is ",
  parseFloat(a) + parseFloat(b_side) + parseFloat(c)
);
// 3
...
2020 - birthYear >= 18
  ? console.log(`You are ${2020 - birthYear}. You are old enough to drive!`)
  : console.log(
      `You are ${2020 - birthYear}. You will be allowed to drive after ${
        18 - birthYear
      } years.`
    );
